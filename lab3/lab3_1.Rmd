...
```{r}
hsprings <- tibble(temp_C =temp, scientist = name, spring)
hsprings
```
...
## Practice
1. As part of homework 2, you saved data on the five tallest mountains in the world. Reload that data below and use the `str()` function to explore its structure.  
```{r}
mountains <- read_csv("../lab2/mountains.csv")
str(mountains)
```
